...
"undefined" != typeof module && "undefined" != typeof exports && module.exports === exports && (module.exports = "ui.router"), function(a, b, c) {
    ...
    function q(a, b) {
        ...
        this.study = function(i) {
            ...
            var p = g(i || {}),
                ...
                r = [],
                s = {};
            return R(i, n), i = r = s = null, function(d, f, g) {
                function h() {
    ...
    function v(a, d) {
        ...
        this.rule = function(a) {
            ...
            var c,
                h = O(b);
            if (O(a) && (a = d.compile(a)), !h && !N(b) && !Q(b))
    ...
    function w(a, e) {
        ...
        function w(a, e, f, h, l, n, q, r, u) {
            ...
            return y.locals = {
                ...
                if (f.inherit && (c = i(n, c || {}, z.$current, p)), !p.params.$$validates(c))
                    return G;
                ...
                if (f.reload) {
                    ...
                    for (; F && F === o[A] && F.ownParams.$$equals(c, l);)
                        H = I[A] = F.locals, A++, F = u[A];
                if (x(b, c, j, l, H, f))
                    return r && (c["#"] = r), z.params = c, T(z.params, n), T(k(b.params.$$keys(), n), b.locals.globals.$stateParams), f.location && b.navigable && b.navigable.url && (q.push(b.navigable.url, c, {
                        $$avoidResync: !0,
                ...
                if (c = k(b.params.$$keys(), c || {}), r && (c["#"] = r), f.notify && a.$broadcast("$stateChangeStart", b.self, c, j.self, l, f).defaultPrevented)
                    return a.$broadcast("$stateChangeCancel", b.self, c, j.self, l), null == z.transition && q.update(), E;
                for (var K = e.when(H), L = A; L < u.length; L++, F = u[L])
                ...
                var N = z.transition = K.then(function() {
                    var d,
                        ...
                        g;
                    if (z.transition !== N)
                        return a.$broadcast("$stateChangeCancel", b.self, c, j.self, l), D;
